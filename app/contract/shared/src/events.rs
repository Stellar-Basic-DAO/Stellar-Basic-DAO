...
pub fn publish_upgrade_completed(
    env: &Env,
    admin: &Address,
    old_version: u32,
    new_version: u32,
...
pub fn publish_contract_migrated(
    env: &Env,
    admin: &Address,
    from_version: u32,
    to_version: u32,
...
pub fn publish_aux_indices_cleaned(
    env: &Env,
    commitment: BytesN<32>,
    indices_removed: u32,
) {
...
pub fn publish_dispute_expiry_action_set(
    env: &Env,
    action: crate::types::DisputeExpiryAction,
) {
...
pub fn publish_fee_collector_rotated(
    env: &Env,
...
pub fn publish_upgrade_window_set(
    env: &Env,
    admin: Address,
    window_start: u64,
    window_end: u64,
