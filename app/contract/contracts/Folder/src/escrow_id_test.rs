...
use crate::{ StellarBasicDAOContract,  StellarBasicDAOContractClient};
use soroban_sdk::{
...
fn test_escrow_id_rejects_negative_amount() {
    ...
    assert_eq!(result, Err(Ok(crate::errors:: StellarBasicDAOError::InvalidAmount)));
}
...
fn test_escrow_id_rejects_oversized_salt() {
    ...
    assert_eq!(result, Err(Ok(crate::errors:: StellarBasicDAOError::InvalidSalt)));
}
